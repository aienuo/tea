...
public class FileUtils {
     ...
     * @param fileType - 文件类型
     */
    public static void doFileDownloadByFileUrl(final String filePath, final String fileName, final String fileType, final HttpServletResponse httpServletResponse) {
        // 名称
        String title = URLEncoder.encode(fileName, StandardCharsets.UTF_8).replaceAll("\\+", "%20");
        ...
        httpServletResponse.setHeader(HttpHeaders.CONTENT_DISPOSITION, "attachment;filename=" + title + fileType);
