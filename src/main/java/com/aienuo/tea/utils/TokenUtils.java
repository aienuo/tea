...
public class TokenUtils {
    ...
    // 公钥
    private static String publicKey = "04f2aaa7c70b5b77caddfe0d61991a0497c7a3f2408ad8ea100b3d91173b04def11e247471dcb0348a1daea9ddccaa30d0cb2822da13ec11810bc94c0ec078cf75";
    // 私钥
    private static String privateKey = "03ace564b89ae0f2ebf11a7b227c5fd960bf4a04d5d3ceeb964cc87f257460b6";
    ...
    public static String getTokenByUsername(String domain, String clientType, String username) {
        try {
            ...
            return "TGT-" + SM2Utils.encrypt(id, publicKey) + "-" + get4UUID();
        } catch (Exception e) {
    ...
    public static String getUsernameByToken(String token) {
        try {
            ...
            String decrypt = SM2Utils.decrypt(id,  privateKey);
